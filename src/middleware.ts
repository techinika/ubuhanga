...
const CSP = [
  ...
  "img-src 'self' data: https://img.youtube.com https://*.ytimg.com https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net https://*.google.com https://*.googleusercontent.com https://*.gstatic.com",
  ...
  "connect-src 'self' https://*.firebaseio.com https://*.googleapis.com https://*.firebase.com wss://*.firebaseio.com https://*.google.com https://*.googleadservices.com https://*.doubleclick.net ep1.adtrafficquality.google",
  "font-src 'self'",
  "media-src 'self'",
  "manifest-src 'self'",
  "form-action 'self'",
