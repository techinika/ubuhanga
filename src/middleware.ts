...
const CSP = [
  ...
  "connect-src 'self' https://*.firebaseio.com https://*.googleapis.com https://*.firebase.com wss://*.firebaseio.com https://*.google.com https://*.googleadservices.com https://*.doubleclick.net",
  "font-src 'self'",
  "media-src 'self'",
  "manifest-src 'self'",
].join("; ");
